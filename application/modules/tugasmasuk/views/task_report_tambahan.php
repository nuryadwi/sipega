    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="card-description">
                Laporan tugas tambahan pegawai
            </p>
        </div>
        <div class="card-body">
                    ...
                    <table class="table table-sm table-hover datatable">
                        ...
                        foreach($tugas as $t) : ?>
                            <tr>
                                ...
                                <td>
                                <a style="color:white;" class="btn btn-info btn-sm" data-toggle="modal" data-target="#ModalDetail<?=$t->id_tambahan;?>"><i style="color:white;" class="ti-zoom-in"></i> Detail</a> 
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <p>
                <?php if ($t->file != 'no-file'): ?>
                    ...
                    <a href="<?php echo base_url().'tugasmasuk/download_skp/'.$t->id_tambahan; ?>" class=""><i class="fa fa-paperclip"></i><?=$t->file?></a>
                <?php endif?>
            </p>
            <div class="boxDivider"></div>
          </div>
          ...
          <a href="<?php echo base_url('task_incoming_daily/approve/').$t->id_tambahan ?>" class="btn btn-primary btn-sm" name="approve"><i class="fa fa-check"></i> Approve</a>
        </div>
      </div>
    </div>
</div>
