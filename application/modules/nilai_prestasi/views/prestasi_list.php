                    ...
                    <table class="table table-sm table-bordered datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="<?php echo base_url().'nilai_prestasi/detail/'.$staff->user_id;?>" class="btn btn-primary mr-1 btn-sm" data-toggle="tooltip" data-html="true" title="Nilai"><span class="ti-marker-alt"></span></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
