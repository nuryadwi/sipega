                    ...
                    <table class="table table-sm table-hover table-striped datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="<?php echo base_url().'nilai_perilaku/detail/'.$staff->user_id;?>" class="btn btn-primary mr-1 btn-sm" data-toggle="tooltip" data-html="true" title="Nilai"><span class="ti-marker-alt"></span></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
